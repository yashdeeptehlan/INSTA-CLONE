...
import userSearchUser from "../../hooks/useSearchUser"
...
const Search = () => {
  ...
  const { user, isLoading, getUserProfile, setUser } = userSearchUser()

  const handleSearchUser = (e) => {
    e.preventDefault()
    getUserProfile(searchRef.cureent.value)
  }
  ...
  return (
    <>
        ...
        <Modal isOpen={isOpen} onClose={onClose} motionPreset="slideInLeft">
            <ModalOverlay />
            <ModalContent bg={"black"} border={"1px sloid gray"} maxW={"400px"}>
